...
void readFile(const string csvFile, list<Employee> &emps) {
...
void addEmployee(list<Employee> &emps, int salary, int department, int &maxID) {
    Employee emp;
    emp.setID(++maxID);
    emp.setSalary(salary);
    emp.setDepartment(department);
...
void updateEmployee(list<Employee> &emps, int id, int salary, int department) {
    bool isValid = false;
...
void deleteEmployee(list<Employee> &emps, int id) {
...
void operation(const string txtFile, list<Employee> &emps, int &maxID) {
...
void writeFile(list<Employee> &emps) {
    ofstream file("list_solution.csv");
